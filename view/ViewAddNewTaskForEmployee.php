      ...
      <form id="projectForm">
        <div class="row g-3">
          ...
          <div class="col-md-12">
            ...
            <input type="number" class="form-control" placeholder="القيمة اختياري ">
          </div>

            <!-- ملف واحد -->
          <div class="col-md-12">
            <label class="form-label">اسم التقرير </label>
            <input type="text" class="form-control" placeholder="اسم التقرير " required>
          </div>

          <!-- ملف واحد -->
          <div class="col-md-6">
            <label class="form-label">اسم الملف </label>
            <input type="text" class="form-control" placeholder="اسم ملف " required>
          </div>
          <div class="col-md-6">
          ...
          <div class="col-12 text-center mt-4">
            <button type="submit" class="btn-blue btn-lg px-5">حفظ</button>
          </div>
